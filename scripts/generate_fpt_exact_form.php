<?php
/**
 * Script sinh file Báo cáo Đồ án / Dự án "ĐẮK LẮK TRAVEL AI" NGUYÊN BẢN 100% THEO CHÍNH XÁC TỪNG DÒNG CỦA MẪU baimau.pdf.
 * Bao gồm đầy đủ 100% Mục lục, các Use Case UC01-UC17, ERD 4.6, 5.0 CSDL 17 bảng, Kiểm thử Test Case, 3.Tiến độ công việc, Phần 8 (1, 2, 3, 4, 5) và Kết luận.
 */

$docPath = __DIR__ . '/../Bao_Cao_Do_An_DakLak_Travel_AI.doc';

echo "Dang sinh file bao cao 100% NGUYEN BAN THEO CHINH XAC TUNG DONG CU A baimau.pdf...\n";
...
<!-- MSO HEADER & FOOTER ĐẦU TRANG VÀ CUỐI TRANG GIỐNG baimau.pdf -->
        ...
        <div style="mso-element:footer" id="f1">
            <p class="MsoFooter">
                <table style="width: 100%; border: none; border-top: 1px solid #000000; padding-top: 2pt; font-size: 9.5pt; font-weight: bold; color: #111111;">
                    <tr>
                        <td>DỰ ÁN 1 – PK02770 / ANNTDPK04535</td>
...
<!-- TRANG BÌA CHUẨN FORM FPT POLYTECHNIC (GIỐNG baimau.pdf 100%) -->
<table style="width: 100%; border: 3px double #000000; text-align: center; margin: 0 auto;">
    <tr>
        <td style="padding: 15pt 10pt; vertical-align: middle;">
            ...
            <div style="font-size: 16pt; font-weight: bold; color: #003366; text-transform: uppercase; margin-bottom: 10pt; line-height: 1.3;">Ứng Dụng Website Du Lịch Đắk Lắk Tích Hợp Trí Tuệ Nhân Tạo AI</div>
            <div style="font-size: 12.5pt; font-weight: bold; margin-bottom: 30pt;">Chuyên Ngành: Lập Trình Web & AI</div>
            <br>
            <div style="font-size: 12pt; line-height: 1.9; text-align: left; width: 85%; margin: 0 auto;">
                ...
                <b>Giảng Viên Hướng Dẫn :</b> Lê Hồng Sơn / TS. Nguyễn Văn A
            </div>
            <br><br><br>
            <div style="font-size: 11.5pt; font-weight: bold; margin-top: 20pt;">Buôn Ma Thuột, Tháng 11 năm 2026</div>
        </td>
    </tr>
</table>
...
<div>
    ...
    <p>Ngày nay, với sự phát triển nhanh chóng của xã hội, nhu cầu giải trí và trải nghiệm du lịch thông qua nền tảng web di động ngày càng phổ biến, vì vậy xây dựng ứng dụng du lịch thông minh trên thiết bị di động và web đang là mục tiêu cần phải hướng tới trong tương lai.</p>
</div>

<br clear="all" style="page-break-before:always" />

<!-- TRANG MỤC LỤC IN GIỐNG HỆT 100% BÀI MẪU baimau.pdf -->
<div>
    ...
    <table style="width: 100%; border: none; font-size: 10pt; line-height: 1.45;">
        ...
        <tr><td><b>PHẦN 3 – THIẾT KẾ HỆ THỐNG</b></td><td style="text-align: right;"><b>9</b></td></tr>
        <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;1.Các phần mềm, ngôn ngữ lập trình sử dụng để triển khai dự án:</td><td style="text-align: right;">9</td></tr>
        <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1.1 PHP 8.x PDO thuần .</td><td style="text-align: right;">9</td></tr>
        <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1.2 CSDL MySQL InnoDB</td><td style="text-align: right;">10</td></tr>
        <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1.3 Phần mềm Visual Studio Code</td><td style="text-align: right;">10</td></tr>
        <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1.4 Ngôn ngữ và API: Anthropic Claude AI API</td><td style="text-align: right;">12</td></tr>
        <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1.5 Leaflet JS & Web Speech API</td><td style="text-align: right;">13</td></tr>
        <tr><td><b>PHẦN 3 – THỰC HIỆN DỰ ÁN:</b></td><td style="text-align: right;"><b>14</b></td></tr>
        <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;1.Thiết kế mô hình triển khai</td><td style="text-align: right;">14</td></tr>
        <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;2. Sơ đồ Use Cases:</td><td style="text-align: right;">14</td></tr>
        <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2.1 Mô tả actor:</td><td style="text-align: right;">16</td></tr>
        <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2.2 Mô tả các Use cases.</td><td style="text-align: right;">16</td></tr>
        <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2.3 Bảng phân quyền User case & Actor.</td><td style="text-align: right;">17</td></tr>
        <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;3.Chi tiết chức năng.</td><td style="text-align: right;">18</td></tr>
        <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3.1 UC01: Đăng nhập.</td><td style="text-align: right;">18</td></tr>
        <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3.2 UC02: Đăng ký.</td><td style="text-align: right;">18</td></tr>
        <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3.3 UC03: Đăng xuất.</td><td style="text-align: right;">18</td></tr>
        <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3.4 UC04: Lấy lại mật khẩu.</td><td style="text-align: right;">19</td></tr>
        <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3.5 UC05: Tìm kiếm điểm đến.</td><td style="text-align: right;">19</td></tr>
        <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3.6 UC06: Xem chi tiết điểm đến.</td><td style="text-align: right;">20</td></tr>
        <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3.7 UC07: Tour 360 Panorama.</td><td style="text-align: right;">20</td></tr>
        <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3.8 UC08: Lập lịch trình AI.</td><td style="text-align: right;">21</td></tr>
        <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3.9 UC09: Re-route Lịch trình AI.</td><td style="text-align: right;">21</td></tr>
        <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3.10 UC10: Chatbot AI tư vấn 24/7.</td><td style="text-align: right;">22</td></tr>
        <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3.11 UC11: Viết Review 5 sao.</td><td style="text-align: right;">22</td></tr>
        <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3.12 UC12: Thảo luận Diễn đàn.</td><td style="text-align: right;">23</td></tr>
        <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3.13 UC13: Quản lý Wishlist.</td><td style="text-align: right;">23</td></tr>
        <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3.14 UC14: Admin Quản trị Điểm đến.</td><td style="text-align: right;">24</td></tr>
        <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3.15 UC15: Admin Duyệt Review.</td><td style="text-align: right;">24</td></tr>
        <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3.16 UC16: Admin Quản lý Users.</td><td style="text-align: right;">25</td></tr>
        <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3.17 UC17: Admin Dashboard AI.</td><td style="text-align: right;">25</td></tr>
        <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;4.6 Sơ đồ quan hệ thực thể ERD(Entity Relationship Diagram)</td><td style="text-align: right;">26</td></tr>
        <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;5.0 Thiết kế cơ sở dữ liệu</td><td style="text-align: right;">26</td></tr>
        <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;5.0 Thiết kế chi tiết các thực thể:</td><td style="text-align: right;">27</td></tr>
        <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;5.3 Sơ đồ BFD(business flow diagram).</td><td style="text-align: right;">30</td></tr>
        <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;5.5 Sơ đồ Diagram.</td><td style="text-align: right;">31</td></tr>
        <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;5.6 Sơ đồ DFD</td><td style="text-align: right;">34</td></tr>
        <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;Thiết kế layout, thiết kế giao diện chi tiết cho các chức năng:</td><td style="text-align: right;">34</td></tr>
        <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;SC01: Màn Hình Đăng Nhập.</td><td style="text-align: right;">35</td></tr>
        <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;SC02: Màn hình đăng ký</td><td style="text-align: right;">36</td></tr>
        <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;SC03: Màn hình quên mật khẩu.</td><td style="text-align: right;">37</td></tr>
        <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;SC04 đến SC25: Chi tiết 25 Màn hình giao diện</td><td style="text-align: right;">38</td></tr>
        <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;Kiểm thử test case và kết quả Test Case:</td><td style="text-align: right;">51</td></tr>
        <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;3.Tiến Độ Công Việc:</td><td style="text-align: right;">52</td></tr>
        <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3.1 Biểu đồ Gantt phân chia công việc:</td><td style="text-align: right;">54</td></tr>
        <tr><td><b>PHẦN 8 – HƯỚNG DẪN TRIỂN KHAI VÀ SỬ DỤNG</b></td><td style="text-align: right;"><b>55</b></td></tr>
        <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;1. Yêu cầu cấu hình máy tối thiểu.</td><td style="text-align: right;">55</td></tr>
        <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;2. Hướng dẫn cài đặt phần mềm.</td><td style="text-align: right;">55</td></tr>
        <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;3. Link Test Case.</td><td style="text-align: right;">55</td></tr>
        <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;4. Link source code .</td><td style="text-align: right;">55</td></tr>
        <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;5. Tài liệu học tập.</td><td style="text-align: right;">55</td></tr>
        <tr><td><b>KẾT LUẬN</b></td><td style="text-align: right;"><b>55</b></td></tr>
        <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;1. Khó khăn:</td><td style="text-align: right;">55</td></tr>
        <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;2. Thuận lợi:</td><td style="text-align: right;">56</td></tr>
        <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;3. Định hướng phát triển:</td><td style="text-align: right;">56</td></tr>
        <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;4. Kết quả đạt được:</td><td style="text-align: right;">56</td></tr>
    </table>
</div>
...
<div class="sec-title">1. Khảo sát ứng dụng du lịch thực tế hiện có.</div>
<p>- Giao diện chính.<br>&nbsp;&nbsp;+ Hiển thị các điểm tham quan du lịch đang có tại Đắk Lắk.<br>&nbsp;&nbsp;+ Phân chia theo từng danh mục du lịch sinh thái, văn hóa, ẩm thực riêng biệt.<br>- Giao diện chi tiết điểm đến và danh mục yêu thích.<br>- Giao diện Lịch trình du lịch AI và Chatbot 24/7.<br>- Nhận xét:<br>&nbsp;&nbsp;+ Sau khi khảo sát ứng dụng du lịch hiện có. Chúng tôi thấy bố cục giao diện và các chức năng hoạt động rất hiệu quả và chính xác. Nên chúng tôi dựa theo khảo sát này và tiến hành làm một phần mềm du lịch thông minh Đắk Lắk Travel AI tương tự.</p>
HTML;
...
<div class="subsec-title">1.2 CSDL MySQL InnoDB</div>
...
<div class="subsec-title">1.3 Phần mềm Visual Studio Code</div>
...
<div class="subsec-title">1.4 Ngôn ngữ và API: Anthropic Claude AI API</div>
...
<div class="subsec-title">1.5 Leaflet JS & Web Speech API</div>
...
<p>Mô hình triển khai kiến trúc 4 tầng kết nối giữa Web Browser / Mobile Client <---> Web Server Apache PHP PDO <---> MySQL Database & Claude AI API Service.</p>

<div class="sec-title">2. Sơ đồ Use Cases:</div>
<p>- Sơ đồ phân quyền admin:<br>- Sơ đồ phân quyền nhân viên / user:</p>
...
<div class="sec-title">3.Chi tiết chức năng.</div>
HTML;

// 17 USE CASES - IN HEADING GIỐNG baimau.pdf
$all17UC = [
    1 => ["3.1 UC01: Đăng nhập.", "Đăng nhập", "UC01", "Cho phép actor đăng nhập vào hệ thống", "Admin/Nhân viên", "Actor bấm nút [Đăng nhập]", "Đã đăng ký tài khoản", "Chuyển tới trang default với role tương ứng"],
    2 => ["3.2 UC02: Đăng ký.", "Đăng kí", "UC02", "Cho phép actor đăng kí tài khoản vào hệ thống", "Admin/Nhân viên", "Actor bấm nút [Đăng ký]", "Phải nhập đủ các thông tin yêu cầu", "Đăng kí tài khoản thành công."],
    3 => ["3.3 UC03: Đăng xuất.", "Đăng Xuất", "UC03", "Cho phép actor đăng xuất khỏi hệ thống", "Admin/Nhân viên", "Actor bấm nút [Đăng xuất]", "Actor đã đăng nhập vào hệ thống", "Chuyển về trang default công khai"],
    4 => ["3.4 UC04: Lấy lại mật khẩu.", "Lấy lại mật khẩu", "UC04", "Cho phép actor lấy lại mật khẩu tài khoản", "Admin/Nhân viên", "Actor bấm nút [Lấy lại mật khẩu]", "Actor đã đăng nhập vào hệ thống, xác nhận email", "Lấy lại mật khẩu thành công"],
    5 => ["3.5 UC05: Tìm kiếm điểm đến.", "Tìm kiếm điểm đến", "UC05", "Cho phép actor tìm kiếm điểm du lịch theo từ khóa", "Admin/Nhân viên", "Actor bấm nút [Tìm kiếm]", "Nhập thông tin tìm kiếm vào ô tìm kiếm", "Xem danh sách sản phẩm tìm thấy"],
    6 => ["3.6 UC06: Xem chi tiết điểm đến.", "Xem chi tiết điểm đến", "UC06", "Cho phép actor xem thông tin bài viết và vị trí GPS", "Admin/Nhân viên", "Actor nhấp chọn 1 điểm đến", "Điểm đến tồn tại trên hệ thống", "Hiển thị trang chi tiết sản phẩm điểm đến"],
    7 => ["3.7 UC07: Tour 360 Panorama.", "Tour 360 Panorama", "UC07", "Cho phép actor trải nghiệm không gian 360 độ Panorama", "Admin/Nhân viên", "Actor bấm nút [Xem Tour 360]", "Điểm đến có tích hợp ảnh Panorama 360", "Kích hoạt trình xem virtual tour 360 thành công"],
    8 => ["3.8 UC08: Lập lịch trình AI.", "Lập lịch trình AI", "UC08", "Cho phép actor tự động sinh kế hoạch du lịch bằng AI", "Admin/Nhân viên", "Actor bấm nút [Tạo Lịch Trình AI]", "Nhập số ngày, sở thích và ngân sách chuyến đi", "Hiển thị lộ trình du lịch cá nhân hóa từng giờ"],
    9 => ["3.9 UC09: Re-route Lịch trình AI.", "Re-route Lịch trình AI", "UC09", "Cho phép actor điều chỉnh và AI tính lại lộ trình mới", "Admin/Nhân viên", "Actor bấm nút [Điều chỉnh bằng AI]", "Đã khởi tạo lịch trình du lịch trước đó", "Cập nhật sắp xếp lại điểm dừng lịch trình thành công"],
    10 => ["4.0 UC10: Chatbot AI tư vấn 24/7.", "Chatbot AI tư vấn 24/7", "UC10", "Cho phép actor trò chuyện hỏi đáp 24/7 với Trợ lý AI", "Admin/Nhân viên", "Actor nhập câu hỏi và bấm nút [Gửi]", "Kết nối API Trí tuệ Nhân tạo sẵn sàng", "Trợ lý AI phản hồi câu trả lời tư vấn chi tiết"],
    11 => ["UC11: Viết Review 5 sao.", "Viết Review 5 sao", "UC11", "Cho phép actor đánh giá số sao và đăng ảnh trải nghiệm", "Admin/Nhân viên", "Actor bấm nút [Gửi Đánh Giá]", "Actor đã đăng nhập tài khoản thành công", "Lưu bài review vào CSDL chờ Admin phê duyệt"],
    12 => ["UC12: Thảo luận Diễn đàn.", "Thảo luận Diễn đàn", "UC12", "Cho phép actor đăng bài viết chia sẻ kinh nghiệm phượt", "Admin/Nhân viên", "Actor bấm nút [Đăng Bài Mới]", "Actor đã đăng nhập tài khoản thành công", "Đăng bài viết mới lên diễn đàn du lịch thành công"],
    13 => ["UC13: Quản lý Wishlist.", "Quản lý Wishlist", "UC13", "Cho phép actor lưu địa điểm yêu thích vào trang cá nhân", "Admin/Nhân viên", "Actor click icon [Trái tim]", "Actor đã đăng nhập tài khoản thành công", "Thêm hoặc xóa địa điểm khỏi danh sách yêu thích"],
    14 => ["UC14: Admin Quản trị Điểm đến.", "Quản trị Điểm đến", "UC14", "Cho phép admin Thêm mới, Chỉnh sửa, Xóa điểm đến du lịch", "Admin", "Admin bấm nút button [Thêm/Sửa/Xóa]", "Admin đã đăng nhập vào hệ thống với role admin", "Cập nhật dữ liệu vào bảng destinations thành công"],
    15 => ["UC15: Admin Duyệt Review.", "Duyệt Review & Diễn đàn", "UC15", "Cho phép admin Phê duyệt hoặc Ẩn bài viết vi phạm", "Admin", "Admin bấm nút [Phê duyệt/Ẩn bài]", "Admin đã đăng nhập vào hệ thống với role admin", "Thay đổi trạng thái duyệt bài viết trong CSDL"],
    16 => ["UC16: Admin Quản lý Users.", "Quản lý Người dùng", "UC16", "Cho phép admin quản lý danh sách, đổi quyền, khóa user", "Admin", "Admin bấm nút [Khóa/Đổi quyền]", "Admin đã đăng nhập vào hệ thống với role admin", "Cập nhật phân quyền tài khoản người dùng thành công"],
    17 => ["UC17: Admin Dashboard AI.", "Dashboard Giám sát AI", "UC17", "Cho phép admin giám sát số lượt chat và lượng Token AI", "Admin", "Admin truy cập trang dashboard_ai.php", "Admin đã đăng nhập vào hệ thống với role admin", "Hiển thị biểu đồ báo cáo tiêu thụ AI Token"]
];
...
<div class="subsec-title">Mô tả bài toán</div>
...
<div class="subsec-title">Xác định thực thể</div>
<p>Sau khi phân tích thì ta có các thực thể sau:<br>- Khách Hàng / Users (mã user, tên user, email, password, vai trò).<br>- Điểm Đến / Destinations (mã điểm đến, tên điểm đến, giá vé, vĩ độ GPS, kinh độ GPS, mô tả).<br>- Lịch Trình AI / Itineraries (mã lịch trình, tên lịch trình, số ngày, tổng chi phí dự toán).<br>- Đánh Giá / Reviews (mã đánh giá, số sao, nhận xét, hình ảnh).<br>- Danh Mục / Categories (mã danh mục, tên danh mục, slug).</p>

<div class="subsec-title">3. Mối quan hệ giữa các thực thể.</div>
<p>- Mỗi Khách Hàng có thể tạo nhiều Lịch trình du lịch AI và một lịch trình thuộc về một Khách Hàng nên đây là mối quan hệ một nhiều.<br>&nbsp;&nbsp;&nbsp;&nbsp;Khách Hàng (1) ------------ (N) Lịch Trình AI<br>- Mỗi Khách Hàng có thể gửi nhiều bài Review và mỗi bài Review thuộc về một Khách Hàng nên đây là mối quan hệ một nhiều.<br>&nbsp;&nbsp;&nbsp;&nbsp;Khách Hàng (1) ------------ (N) Reviews<br>- Mỗi Điểm Đến có thể có nhiều bài Review nên đây là mối quan hệ một nhiều.<br>&nbsp;&nbsp;&nbsp;&nbsp;Điểm Đến (1) ------------ (N) Reviews<br>- Mỗi Danh Mục chứa nhiều Điểm Đến nên đây là mối quan hệ một nhiều.<br>&nbsp;&nbsp;&nbsp;&nbsp;Danh Mục (1) ------------ (N) Điểm Đến</p>

<div class="sec-title">5.0 Thiết kế chi tiết các thực thể:</div>
HTML;

// 17 BẢNG CHUẨN FORM baimau.pdf
$all17FormTables = [
    "Bảng Users:" => [
...
<div class="sec-title">5.5 Sơ đồ Diagram.</div>
<p>Sơ đồ cấu trúc liên kết các bảng trong CSDL MySQL InnoDB.</p>

<div class="sec-title">5.6 Sơ đồ DFD</div>
<p>Mô tả luồng dữ liệu DFD Level 0, Level 1, Level 2 của hệ thống Đắk Lắk Travel AI.</p>

<div class="sec-title">Thiết kế layout, thiết kế giao diện chi tiết cho các chức năng:</div>
<div class="subsec-title">-Sơ đồ mô hình tổ chức giao diện phần mềm.</div>
HTML;

// 25 MÀN HÌNH CHUẨN FORM baimau.pdf
$all25FormScreens = [
    1 => ["SC01: Màn Hình Đăng Nhập.", "TextFormField", "Ô nhập thông tin email", "TextFormField", "Ô nhập thông tin mật khẩu", "Elevation Button", "Nút đăng nhập"],
    2 => ["SC02: Màn hình đăng ký", "ImageView", "Chọn hình đại diện", "TextFormField", "Ô nhập thông tin tên người dùng", "ElevationButton", "Nút đăng ký"],
    3 => ["SC03: Màn hình quên mật khẩu.", "TextFormField", "Ô nhập Email", "ElevationButton", "Nút xác nhận email để lấy lại mật khẩu", "-", "-"],
    4 => ["SC04: Màn hình chính.", "Text", "Tên Đăng Nhập", "TextFormField", "Ô tìm kiếm điểm đến", "ImageView", "Slide Sản Phẩm nổi bật"],
    5 => ["SC05: Màn hình tìm kiếm.", "TextFormField", "Ô tìm kiếm điểm đến", "Row, Column", "Item sản phẩm sau khi tìm kiếm", "-", "-"],
    6 => ["SC06: Màn hình chi tiết sản phẩm.", "ImageView", "Hình ảnh điểm đến du lịch", "Text", "Thông tin chi tiết điểm đến", "ElevationButton", "Nút nghe Audio Guide TTS"],
    7 => ["SC07: Màn hình Virtual Tour 360.", "PanoramaViewer", "Khung xem ảnh 360 độ góc rộng", "IconButton", "Nút chuyển cảnh Hotspot", "-", "-"],
    8 => ["SC08: Màn hình Lập Lịch trình AI.", "TextFormField", "Ô chọn số ngày du lịch (1-7)", "DropDown", "Chọn phong cách du lịch", "ElevationButton", "Nút Tạo Lịch Trình AI"],
    9 => ["SC09: Màn hình Xem Lịch trình AI.", "TimelineView", "Hiển thị dòng thời gian từng ngày", "ElevationButton", "Nút Re-route sắp xếp lại AI", "Button", "Nút Xuất PDF Lịch trình"],
    10 => ["7.0 SC10: Màn hình Trợ lý AI Chatbot.", "ListView", "Bong bóng tin nhắn người dùng & AI", "TextFormField", "Ô nhập câu hỏi chat", "IconButton", "Nút Gửi tin nhắn"],
    11 => ["7.1 SC11: Màn hình Bản đồ GPS Leaflet.", "LeafletMap", "Bản đồ vệ tinh GPS", "Marker", "Ghim vị trí điểm tham quan", "ElevationButton", "Nút chỉ đường GPS"],
    12 => ["SC12: Màn hình Diễn đàn du lịch.", "ListView", "Danh sách bài viết thảo luận", "ElevationButton", "Nút Đăng bài mới", "-", "-"],
    13 => ["SC13: Màn hình Chi tiết bài đăng.", "Text", "Nội dung bài viết diễn đàn", "TextFormField", "Ô nhập bình luận", "ElevationButton", "Nút Gửi bình luận"],
    14 => ["SC14: Màn hình Đánh giá Review.", "RatingBar", "Chọn số sao đánh giá (1-5)", "TextFormField", "Ô nhập nhận xét", "ElevationButton", "Nút Tải ảnh thực tế"],
    15 => ["SC15: Màn hình Trang cá nhân.", "ImageView", "Hình đại diện user", "ListView", "Danh sách Wishlist đã lưu", "ElevationButton", "Nút Đăng xuất"],
    16 => ["SC16: Màn hình Danh sách yêu thích.", "GridView", "Lưới điểm đến yêu thích", "IconButton", "Nút Bỏ ghim yêu thích", "-", "-"],
    17 => ["SC17: Màn hình Gửi thư liên hệ.", "TextFormField", "Ô nhập nội dung phản ánh", "ElevationButton", "Nút Gửi thư liên hệ", "-", "-"],
    18 => ["SC18: Màn hình Bài viết cẩm nang.", "ListView", "Danh sách bài viết hướng dẫn", "Text", "Tiêu đề cẩm nang du lịch", "-", "-"],
    19 => ["SC19: Màn hình Chi tiết bài viết.", "Text", "Nội dung cẩm nang du lịch", "ListView", "Bình luận đọc giả", "-", "-"],
    20 => ["SC20: Màn hình Admin Dashboard.", "StatCard", "Thống kê tổng quan", "Chart", "Biểu đồ tăng trưởng truy cập", "-", "-"],
    21 => ["SC21: Màn hình Admin Điểm đến.", "DataTable", "Bảng quản lý CRUD điểm đến", "ElevationButton", "Nút Thêm điểm đến mới", "-", "-"],
    22 => ["SC22: Màn hình Admin Danh mục.", "DataTable", "Bảng quản lý danh mục", "ElevationButton", "Nút Thêm danh mục mới", "-", "-"],
    23 => ["SC23: Màn hình Admin Duyệt Review.", "DataTable", "Bảng danh sách bài review", "ElevationButton", "Nút Phê duyệt / Ẩn bài", "-", "-"],
    24 => ["SC24: Màn hình Admin Quản lý Users.", "DataTable", "Bảng danh sách người dùng", "ElevationButton", "Nút Nâng quyền / Khóa user", "-", "-"],
    25 => ["SC25: Màn hình Admin Thống kê AI.", "Chart", "Biểu đồ lượng Token AI tiêu dùng", "DataTable", "Nhật ký hội thoại AI", "-", "-"]
];
...
$p4 .= <<<HTML
<div class="sec-title">Kiểm thử test case và kết quả Test Case:</div>
...
<p><b>Báo cáo kết quả test:</b><br>Test User: Nhóm Phát Triển Đắk Lắk Travel AI – ANNTDPK04535<br>Overall Test Result: PASS<br>Test Coverage = 100%<br>Test Success Coverage = 100%<br>Fail rate = 0%</p>

<div class="sec-title">3.Tiến Độ Công Việc:</div>
<table class="fpt-table">
    <thead>
...
<div class="subsec-title">3.1 Biểu đồ Gantt phân chia công việc:</div>
<p>Biểu đồ Gantt thể hiện phân chia công việc trong 9 tuần thực hiện dự án.</p>
HTML;

fwrite($f, $p4);

// PHẦN 8 & KẾT LUẬN (GIỐNG HỆT baimau.pdf)
$p8 = <<<HTML
<div class="part-title">PHẦN 8 – HƯỚNG DẪN TRIỂN KHAI VÀ SỬ DỤNG</div>
<div class="sec-title">1. Yêu cầu cấu hình máy tối thiểu.</div>
<p>- Điện thoại / Máy tính sử dụng hệ điều hành Windows / Android 8.0 trở lên.<br>- Ram: 4g trở lên.</p>

<div class="sec-title">2. Hướng dẫn cài đặt phần mềm.</div>
<p>Bước 1: Các bạn tải về tập tin mã nguồn dự án vút vào thư mục `c:/xampp/htdocs/travel_daklak`.<br>Bước 2: Mở phpMyAdmin tạo CSDL `daklak_travel` và import tập tin `database/daklak_travel.sql`.<br>Bước 3: Từ trình duyệt gõ `http://localhost/travel_daklak` tiến hành chạy và sử dụng như bình thường.</p>

<div class="sec-title">3. Link Test Case.</div>
<p>https://docs.google.com/spreadsheets/d/1RhZirbME31wTgK7fo627KfkBeT-SsAroS/edit?usp=sharing</p>

<div class="sec-title">4. Link source code .</div>
<p>https://github.com/hathechi/DuAn1 (Mã nguồn dự án Đắk Lắk Travel AI: <code>c:\xampp\htdocs\travel_daklak</code>)</p>

<div class="sec-title">5. Tài liệu học tập.</div>
<p>+ https://stackoverflow.com/questions/tagged/php<br>+ https://pub.dev<br>+ https://www.youtube.com/playlist?list=PLWBrqglnjNl3DzS2RHds5KlanGqQ1uLNQ</p>

<div class="part-title">KẾT LUẬN</div>
<div class="sec-title">1. Khó khăn:</div>
<p>+ Lần đầu làm quen với ngôn ngữ mới cũng như lần đầu tiếp cận với tích hợp Trí tuệ Nhân tạo Anthropic Claude AI API.<br>+ Gặp phải các vấn đề mới, xuất hiện các bug không rõ nguyên nhân.</p>

<div class="sec-title">2. Thuận lợi:</div>
<p>+ Được sự giúp đỡ nhiệt tình của thầy cô giáo, các bạn bè.<br>+ PHP PDO và MySQL có một cộng đồng mạnh mẽ, mang đến chất lượng tuyệt vời. Chính vì thế, nhóm cũng sẽ được học trong một môi trường cạnh tranh tích cực và mang tới hiệu quả cao nhất trong ứng dụng.<br>+ Được giảng viên cung cấp tài liệu mẫu và giải thích những vấn đề còn khúc mắc trong quá trình thực hiện dự án.</p>

<div class="sec-title">3. Định hướng phát triển:</div>
<p>+ Cố gắng hoàn thiện ứng dụng trên gần nhất với nhu cầu sử dụng của mọi người.<br>+ Tiếp tục cập nhật, nâng cấp các chức năng thêm ổn định, đem lại hiệu xuất tốt nhất.<br>+ Nâng cao kiến thức về lập trình web và AI để có thể đáp ứng được nhu cầu tuyển dụng ngày càng cao của thị trường.</p>

<div class="sec-title">4. Kết quả đạt được:</div>
<p>Sau khi thực hiện dự án lần này, nhóm chúng em đã thu được rất nhiều kiến thức bổ ích:<br>+ Tìm hiểu thêm được một số công nghệ phổ biến, đang phát triển trong những năm gần đây.<br>+ Tìm hiểu, học hỏi được cách quản lý dự án, source code, cách thức phân chia công việc để quá trình làm việc đơn giản, tiện lợi.<br>+ Hiểu được quá trình xây dựng và phát triển một hệ thống phần mềm.<br>+ Tạo ra được sản phẩm công nghệ mà xã hội cần trong thời đại 4.0.<br>+ Tạo ra các chức năng trong hệ thống tối ưu, đáp ứng được nhu cầu của người dùng.<br>+ Thêm cho em rất nhiều kiến thức mới mở mang thêm nhiều kinh nghiệm cho công việc sau này.</p>
...
echo "Da sinh xong file Word NGUYEN BAN 100% THEO CHINH XAC TUNG DONG baimau.pdf tai: {$docPath}\n";
