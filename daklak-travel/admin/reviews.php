...
<div class="page-header">
  ...
  <div style="display:flex;gap:8px;flex-wrap:wrap;">
    <a href="<?= url('/admin/contacts.php') ?>" class="filter-btn">📬 Liên hệ</a>
    <a href="<?= url('/public/destinations.php') ?>" class="filter-btn">🗺️ Điểm đến</a>
  </div>
</div>
...
<div class="reviews-table-wrap">
  ...
  <div style="padding:12px 16px; font-size:12px; color:#aaa; border-top:1px solid #f0f0f0;">
    Hiển thị <?= count($reviews) ?> / <?= $stats['total'] ?> đánh giá
  </div>
  <?php endif; ?>
</div>
