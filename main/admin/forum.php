...
<div class="form-box" style="max-width: 100%;">
    ...
    <div style="display:flex; justify-content:center; gap:8px; margin-top:20px;">
        <?php for ($i = 1; $i <= $totalPages; $i++): ?>
            <a href="?page=<?= $i ?>" style="padding:6px 12px; border-radius:6px; font-size:14px; font-weight:600; text-decoration:none; background:<?= $i === $page ? 'var(--green-700)' : '#f1f5f9' ?>; color:<?= $i === $page ? 'white' : '#475569' ?>;">
                <?= $i ?>
            </a>
        <?php endfor; ?>
    </div>
