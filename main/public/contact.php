...
<p class="section-sub">Gửi câu hỏi hoặc góp ý — chúng tôi sẽ phản hồi sớm nhất có thể.</p>
...
<div class="contact-wrap">
  ...
  <div class="contact-panel">
    <div class="form-box" id="contact-form-wrap">
      <div class="form-box-title">✉️ Gửi tin nhắn</div>
      <form id="contact-form" autocomplete="off">
        ...
        <div class="form-group">
          <label>Chủ đề</label>
          <input type="text" name="subject" placeholder="Hỏi về lịch trình, địa điểm...">
        </div>
        <div class="form-group">
          <label>Nội dung *</label>
          <textarea name="message" required placeholder="Mô tả câu hỏi hoặc góp ý của bạn..."></textarea>
        </div>
        <div class="error-msg" id="contact-error"></div>
        <button type="submit" class="btn-submit" id="contact-btn">
          <span class="btn-icon">📤</span> Gửi tin nhắn
        </button>
      </form>
    </div>
  </div>
