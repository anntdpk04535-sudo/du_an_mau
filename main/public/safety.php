...
<div class="safety-banner">
    <div class="safety-banner-content">
        ...
        <p>Thông tin khẩn cấp, hướng dẫn an toàn theo địa hình và cảnh báo thời tiết thời gian thực — giúp chuyến đi Tây Nguyên của bạn luôn an toàn.</p>
    </div>
...
<div class="weather-safe-box">
    ...
    <div class="weather-badge">
        <?= $isRainy ? '🌧️ Đang là mùa mưa (Tháng 5 - 10)' : '☀️ Đang là mùa khô (Tháng 11 - 4)' ?>
    </div>
</div>
...
<p class="section-sub">Các số điện thoại quan trọng cần lưu cẩn khi đi du lịch Đắk Lắk.</p>
