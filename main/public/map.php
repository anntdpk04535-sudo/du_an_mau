...
$pageTitle = 'Bản đồ du lịch - Đắk Lắk Travel AI';
...
<div class="map-layout">
    <div class="map-sidebar">
        <div class="map-sidebar-header">
            <h1>🗺️ Bản đồ du lịch</h1>
            <p>Khám phá <?= count($mapDestinations) ?> điểm đến hấp dẫn tại Đắk Lắk</p>
        </div>
                ...
                <div style="padding:0 2px;">
                    ...
                    <div style="font-size:12px;margin-bottom:8px;display:flex;gap:6px;flex-wrap:wrap;">
                        ${d.rating !== null
                            ...
                            : `<span class="badge-norating">Chưa có đánh giá</span>`
                        }
