  ...
  <div class="auth-card">
    <div class="auth-image">
      <div class="auth-image-content">
        <h2>Khám phá Đắk Lắk<br>cùng AI</h2>
        <p>Lên kế hoạch thông minh, trải nghiệm chân thực. Đăng nhập ngay để lưu lại hành trình của bạn.</p>
      </div>
    </div>
    <div class="auth-form-container">
      ...
      <form method="post">
        ...
        <div class="auth-options">
          ...
          <a href="<?= url('/public/forgot_password.php') ?>">Quên mật khẩu?</a>
        </div>
      ...
      <p style="margin-top:24px; text-align: center; font-size:14px; color:#666;">
        Chưa có tài khoản? <a href="<?= url('/public/register.php') ?>" style="color: var(--green-700); font-weight: 600; text-decoration: none;">Đăng ký ngay</a>
      </p>
    </div>
  </div>
</div>
